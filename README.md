...
- [astral-sh/ruff](https://github.com/astral-sh/ruff) ([v0.0.275](https://github.com/astral-sh/ruff/releases/tag/v0.0.275), 2 days ago) - An extremely fast Python linter, written in Rust.
- [mitsuhiko/rye](https://github.com/mitsuhiko/rye) ([0.9.0](https://github.com/mitsuhiko/rye/releases/tag/0.9.0), 3 days ago) - An Experimental Package Management Solution for Python
