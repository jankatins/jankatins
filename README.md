...
- [mitsuhiko/minijinja](https://github.com/mitsuhiko/minijinja) - MiniJinja is a powerful but minimal dependency template engine for Rust (4 weeks ago)
...
- [charliermarsh/ruff](https://github.com/charliermarsh/ruff) ([v0.0.246](https://github.com/charliermarsh/ruff/releases/tag/v0.0.246), today) - An extremely fast Python linter, written in Rust.
