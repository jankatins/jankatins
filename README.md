...
- [astral-sh/ruff](https://github.com/astral-sh/ruff) ([v0.0.273](https://github.com/astral-sh/ruff/releases/tag/v0.0.273), today) - An extremely fast Python linter, written in Rust.
- [mitsuhiko/rye](https://github.com/mitsuhiko/rye) ([0.8.0](https://github.com/mitsuhiko/rye/releases/tag/0.8.0), 2 days ago) - An Experimental Package Management Solution for Python
- [apache/superset](https://github.com/apache/superset) ([2.1.1rc1](https://github.com/apache/superset/releases/tag/2.1.1rc1), 4 days ago) - Apache Superset is a Data Visualization and Data Exploration Platform
