...
- [astral-sh/rye](https://github.com/astral-sh/rye) ([0.33.0](https://github.com/astral-sh/rye/releases/tag/0.33.0), today) - a Hassle-Free Python Experience
- [astral-sh/packse](https://github.com/astral-sh/packse) ([0.3.15](https://github.com/astral-sh/packse/releases/tag/0.3.15), today) - Python packaging scenarios
- [open-telemetry/opentelemetry-helm-charts](https://github.com/open-telemetry/opentelemetry-helm-charts) ([opentelemetry-demo-0.30.3](https://github.com/open-telemetry/opentelemetry-helm-charts/releases/tag/opentelemetry-demo-0.30.3), 2 days ago) - OpenTelemetry Helm Charts
