...
- [astral-sh/ruff](https://github.com/astral-sh/ruff) ([v0.1.11](https://github.com/astral-sh/ruff/releases/tag/v0.1.11), 1 day ago) - An extremely fast Python linter and code formatter, written in Rust.
- [starship/starship](https://github.com/starship/starship) ([v1.17.1](https://github.com/starship/starship/releases/tag/v1.17.1), 1 day ago) - ☄🌌️  The minimal, blazing-fast, and infinitely customizable prompt for any shell!
