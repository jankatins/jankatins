...
- [grpc/grpc](https://github.com/grpc/grpc) ([v1.64.2](https://github.com/grpc/grpc/releases/tag/v1.64.2), today) - The C based gRPC (C&#43;&#43;, Python, Ruby, Objective-C, PHP, C#)
- [astral-sh/packse](https://github.com/astral-sh/packse) ([0.3.18](https://github.com/astral-sh/packse/releases/tag/0.3.18), today) - Python packaging scenarios
- [open-telemetry/opentelemetry-helm-charts](https://github.com/open-telemetry/opentelemetry-helm-charts) ([opentelemetry-operator-0.62.0](https://github.com/open-telemetry/opentelemetry-helm-charts/releases/tag/opentelemetry-operator-0.62.0), 1 day ago) - OpenTelemetry Helm Charts
