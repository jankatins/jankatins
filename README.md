...
- [starship/starship](https://github.com/starship/starship) ([v1.17.0](https://github.com/starship/starship/releases/tag/v1.17.0), 2 days ago) - ☄🌌️  The minimal, blazing-fast, and infinitely customizable prompt for any shell!
- [so1n/protobuf_to_pydantic](https://github.com/so1n/protobuf_to_pydantic) ([v0.2.3](https://github.com/so1n/protobuf_to_pydantic/releases/tag/v0.2.3), 4 days ago) - Generate a pydantic.BaseModel with parameter verification function from the Python Message object(by the Protobuf file).
- [cantino/mcfly](https://github.com/cantino/mcfly) ([v0.8.4](https://github.com/cantino/mcfly/releases/tag/v0.8.4), 6 days ago) - Fly through your shell history. Great Scott!
